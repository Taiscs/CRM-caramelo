    ...
    <div class="container-fluid py-2">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="<?php echo e(route('dashboard')); ?>">Dashboard do Analista</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(route('campanhas')); ?>">Campanhas</a>
                </li>
                <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\laravel_app\resources\views/campanhas.blade.php ENDPATH**/ ?>